    ...
    const zapId = yield db_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const zap = yield tx.zap.create({
            data: {
                ...
                triggerId: "",
                actions: {
                    create: (_a = parsedData === null || parsedData === void 0 ? void 0 : parsedData.data) === null || _a === void 0 ? void 0 : _a.actions.map((action, index) => ({
        ...
        const trigger = yield tx.trigger.create({
            data: {
                triggerId: (_b = parsedData === null || parsedData === void 0 ? void 0 : parsedData.data) === null || _b === void 0 ? void 0 : _b.availableTriggerId,
                zapId: zap.id
            }
        });
        yield tx.zap.update({
